...
public class InputDialog extends JDialog {
    ...
    public InputDialog(Window owner, String title, String message, String initialValue) {
        ...
        if (inputField != null && initialValue != null) {
    ...
    private void styleUI(Window owner) {
        ...
        inputField.setFont(baseFont.deriveFont(14f * sf));
        inputField.setPreferredSize(new Dimension(ImageUtil.scale(320), ImageUtil.scale(36)));
    ...
    public String getInputText() {
        return inputField.getText() != null ? inputField.getText().trim() : "";
    }
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        panel3.setLayout(new GridLayoutManager(2, 1, new Insets(0, 0, 0, 0), -1, 5));
        contentPane.add(panel3, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, null, null, null, 0, false));
        messageLabel = new JLabel();
        messageLabel.setText("Input Prompt:");
        ...
        panel3.add(inputField, new GridConstraints(1, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
